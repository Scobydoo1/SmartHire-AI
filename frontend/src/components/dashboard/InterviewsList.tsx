...
const allInterviews: Interview[] = [
  { id: '1', jobTitle: 'Senior Frontend Developer', company: 'TechCorp Inc.', status: 'scheduled', scheduledDate: '2026-03-20 at 09:00 AM', stage: 'Technical Interview', duration: '60 min' },
  { id: '2', jobTitle: 'Full Stack Engineer', company: 'StartupXYZ', status: 'completed', completedDate: '2026-03-01', score: 85, stage: 'Final Round', duration: '45 min' },
  { id: '3', jobTitle: 'React Developer', company: 'Digital Solutions', status: 'pending', stage: 'Initial Screening', duration: '30 min' },
  { id: '4', jobTitle: 'UI/UX Developer', company: 'Creative Agency', status: 'completed', completedDate: '2026-02-28', score: 92, stage: 'Behavioral Interview', duration: '40 min' },
  { id: '5', jobTitle: 'TypeScript Engineer', company: 'CloudBase', status: 'pending', stage: 'Initial Screening', duration: '30 min' },
  { id: '6', jobTitle: 'React Native Developer', company: 'MobileFirst Co.', status: 'completed', completedDate: '2026-02-10', score: 71, stage: 'Technical Screen', duration: '50 min' },
]
        ...
        <main className="flex flex-1 flex-col gap-6 p-4 pt-0">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <div className="relative flex-1">
              ...
              <Input placeholder="Search by job or company..." className="pl-9" value={search} onChange={e => setSearch(e.target.value)} />
            </div>
                    ...
                    <CardContent className="flex flex-col gap-3">
                      ...
                      {iv.score !== undefined && (
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm font-semibold text-emerald-400 w-10 text-right">{iv.score}%</span>
                        </div>
                      )}
