...
const upcomingInterviews: UpcomingInterview[] = [
  { id: '1', jobTitle: 'Senior Frontend Developer', company: 'TechCorp Inc.', date: '2026-03-20', time: '09:00 AM', type: 'Technical' },
  { id: '2', jobTitle: 'React Developer', company: 'Digital Solutions', date: '2026-03-25', time: '11:00 AM', type: 'HR' },
]
...
export const ScheduleInterview = memo(() => {
  ...
  const handleBook = () => {
    if (!selectedDate || !selectedTime) { toast.error('Please select a date and time slot.'); return }
          ...
          <div className="grid gap-6 lg:grid-cols-3">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Calendar className="h-5 w-5 text-emerald-500" />Pick a Date
                  </CardTitle>
              ...
              {selectedDate && (
                <Card>
                  ...
                  <CardContent>
                    ...
                    >
                      <Plus className="mr-2 h-4 w-4" />Confirm Booking
                    </Button>
                  </CardContent>
                </Card>
              )}
            ...
            <div className="flex flex-col gap-4">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Video className="h-5 w-5 text-emerald-500" />Upcoming
                  </CardTitle>
