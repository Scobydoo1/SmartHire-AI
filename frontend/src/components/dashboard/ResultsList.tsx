...
const mockResults: InterviewResult[] = [
  { id: '1', jobTitle: 'Full Stack Engineer', company: 'StartupXYZ', completedDate: '2026-03-01', overallScore: 85, technicalScore: 88, communicationScore: 90, problemSolvingScore: 76, stage: 'Final Round', outcome: 'passed' },
  { id: '2', jobTitle: 'UI/UX Developer', company: 'Creative Agency', completedDate: '2026-02-28', overallScore: 92, technicalScore: 95, communicationScore: 92, problemSolvingScore: 88, stage: 'Behavioral Interview', outcome: 'passed' },
  { id: '3', jobTitle: 'React Developer', company: 'Digital Solutions', completedDate: '2026-02-15', overallScore: 54, technicalScore: 50, communicationScore: 65, problemSolvingScore: 48, stage: 'Technical Screen', outcome: 'failed' },
]
