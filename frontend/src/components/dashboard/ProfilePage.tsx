          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <Textarea id="bio" value={form.bio} onChange={handleChange('bio')} rows={3} placeholder="Tell recruiters about yourself..." />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
              ...
              <Button className="w-fit bg-emerald-500 hover:bg-emerald-600 text-black font-semibold mt-2" onClick={() => toast.success('Profile updated!')}>
