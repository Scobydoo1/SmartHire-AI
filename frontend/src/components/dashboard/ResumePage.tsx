...
export const ResumePage = memo(() => {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setUploading(true)
    setTimeout(() => { setUploading(false); setUploaded(true); toast.success(`${file.name} uploaded!`) }, 1500)
  }
        ...
        <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem><BreadcrumbPage>Resume</BreadcrumbPage></BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="flex flex-col gap-4">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Upload className="h-5 w-5 text-emerald-500" />Upload Resume
                  </CardTitle>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <FileText className="h-5 w-5 text-emerald-500" />Current Resume
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center justify-between rounded-lg border p-3">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button size="icon" variant="ghost" className="text-red-400 hover:text-red-300" onClick={() => toast.info('Resume removed.')}>
