 ...
 * Candidate account settings (notifications, preferences).
 * All state is local/mock — ready for backend hookup.
 */
    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <main className="flex flex-1 flex-col gap-6 p-4 pt-0 max-w-2xl">
            ...
            <CardContent className="flex flex-col gap-5">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={v => setPrivacy(prev => ({ ...prev, profileVisible: v }))}
                />
              </div>
              <div className="flex items-center justify-between">
                <div>
                ...
                <Switch
                  ...
                  onCheckedChange={v => setPrivacy(prev => ({ ...prev, shareResults: v }))}
                />
              </div>
            </CardContent>
          </Card>
          ...
          <Button
            className="w-fit bg-emerald-500 hover:bg-emerald-600 text-black font-semibold"
            onClick={handleSave}
          >
